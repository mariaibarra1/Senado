...
namespace EventosService.Controllers
{
    ...
    {
        #region Instancias
        private tbl_rel_evento_invitado_negocio _Negocio = new tbl_rel_evento_invitado_negocio();
        private tbl_rel_evento_invitado entidad = new tbl_rel_evento_invitado();
        #endregion
        ...
        [HttpPost]
        public IActionResult Post([FromBody] tbl_rel_evento_invitado web)
        {
            try
            {
                web.tipoOperacion = 2;
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] tbl_rel_evento_invitado web)
        {
            try
            {
                web.tipoOperacion = 3;
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                entidad = new tbl_rel_evento_invitado();

...
namespace EventosService.Controllers
{
    ...
    [ApiController]
    public class EventoServicioController: ControllerBase
    {
        #region Instancias
        private tbl_rel_evento_servicio_negocio _Negocio = new tbl_rel_evento_servicio_negocio();
        private tbl_rel_evento_servicio entidad = new tbl_rel_evento_servicio();
        #endregion
        ...
        [HttpPost]
        public IActionResult Post([FromBody] tbl_rel_evento_servicio web)
        {
            try
            {
                web.tipoOperacion = 2;
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] tbl_rel_evento_servicio web)
        {
            try
            {
                web.tipoOperacion = 3;
        ...
        public IActionResult Delete(int id)
        {
            try
            {
                entidad = new tbl_rel_evento_servicio();

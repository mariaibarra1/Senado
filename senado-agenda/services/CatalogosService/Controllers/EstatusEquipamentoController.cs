...
namespace CatalogosService.Controllers
{
    ...
    [ApiController]
    public class EstatusEquipamentoController : Controller
    {
        #region Instancias
        private tbl_ca_estatus_equipo_negocio _Negocio = new tbl_ca_estatus_equipo_negocio();
        private tbl_ca_estatus_equipo entidad = new tbl_ca_estatus_equipo();
        #endregion
        ...
        [HttpPost]
        public IActionResult Post([FromBody] tbl_ca_estatus_equipo entidad)
        {
            try
            {
        ...
        [HttpPut]
        public IActionResult Put([FromBody] tbl_ca_estatus_equipo entidad)
        {
            try
            {

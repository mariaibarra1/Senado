...
namespace CatalogosService.Controllers
{
    ...
    public class RolWebController : ControllerBase
    {
        ...
        private tbl_ca_rol_web entidad = new tbl_ca_rol_web();
        #endregion
        [HttpGet]
        ...
        [HttpPost]
        public IActionResult Post([FromBody] tbl_ca_rol_web web) {
            try
            {
                web.tipoOperacion = 2;
        ...
        [HttpPut("{id}")]
        public IActionResult Put(int id, [FromBody] tbl_ca_rol_web web) {
            try
            {
                web.tipoOperacion = 3;
                web.id = id;
